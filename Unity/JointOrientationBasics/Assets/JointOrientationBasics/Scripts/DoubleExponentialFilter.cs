...
public class DoubleExponentialFilter
{
    public class Joint
    {
        ...
        public Joint(CameraSpacePoint position, Windows.Kinect.Vector4 rotation)
        {
    ...
    private Dictionary<JointType, DoubleExponentialFilterData> history;
    ...
    {
        filteredJoints = new Dictionary<JointType, Joint>();
        
        history = new Dictionary<JointType, DoubleExponentialFilterData>();
        foreach (JointType jt in JointType.GetValues(typeof(JointType)))
        {
    ...
    public Joint UpdateJoint(JointType jt, Joint rawJoint, TRANSFORM_SMOOTH_PARAMETERS smoothingParams)
    {
    ...
    public Joint GetFilteredJoint(JointType jt)
    {
